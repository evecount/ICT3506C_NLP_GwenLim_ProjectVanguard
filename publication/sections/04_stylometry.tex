...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{../assets/cross_platform_stylometry.png}
\caption{Three distinct platform manifolds with a perfectly aligned vector mapping linking a single behavioral actor.}
\end{figure}
